...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] weatherDataList = new String[]{"Sunny", "Overcast", "Rainy", "Stormy", "Partly cloudy"};

        // done (4) Append each String from the fake weather data array to the TextView
        for(String weatherType: weatherDataList){
            mWeatherListTextView.append(weatherType + "\n\n\n");
        }
    }
}